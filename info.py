...
PICS = (environ.get('PICS', 'https://telegra.ph/file/504babe67ae701cb458f8.jpg')).split() #SAMPLE PIC
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "junior-adelind-jyttjjjsmmmmmmmmmmmm-d0d4b980.koyeb.app/") #changed here
